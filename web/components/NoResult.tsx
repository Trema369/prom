...
export default function NoResult({ onReconsider }: { onReconsider: () => void }) {
  ...
  return (
    ...
    >
      ...
      <h1 className="font-serif text-5xl text-cream/90 drop-shadow-md sm:text-6xl">That&rsquo;s okay…</h1>
      <p className="mt-1 font-serif text-2xl italic text-rose/90 drop-shadow-sm sm:text-3xl">I respect your decision.</p>
