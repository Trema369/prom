...
export default function Gate({ onUnlock }: { onUnlock: () => void }) {
  ...
  return (
    ...
    >
      <h1 className="font-serif text-5xl leading-tight text-cream drop-shadow-md sm:text-6xl lg:text-7xl">
      ...
      <p className="mx-auto max-w-md text-base text-cream/80 drop-shadow-sm sm:mx-0 sm:text-lg">
