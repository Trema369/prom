...
export default function YesResult() {
  ...
  return (
    <div className="relative w-full max-w-lg text-center text-ink">
      ...
      >
        <h1 className="font-serif text-5xl text-cream drop-shadow-md sm:text-6xl">
          You said YES!&nbsp;&#9825;
        </h1>
        <p className="mt-1 font-serif text-3xl italic text-rose-bright drop-shadow-sm sm:text-4xl">I&rsquo;m so excited!</p>

        <HeartDivider />

        <p className="text-base uppercase tracking-[0.25em] text-cream/85 drop-shadow-sm">See you on</p>
        <p className="font-serif text-4xl text-cream drop-shadow-sm sm:text-5xl">{PROM_DATE}</p>
